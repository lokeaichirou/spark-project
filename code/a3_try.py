...
taskEventsDf = spark.read.schema(taskEventsSchema).csv("../data/task_events/part-00000-of-00500.csv.gz")
...
# Apply the pyspark.sql.functions.mean on the extracted aggregation column "count" of dataframe numOfTasksPerJobDf and
# name this column as "avg", and we select it from numOfTasksPerJobDf frame.
pandas_dataframe_1 = avgNumOfTasksPerJob.toPandas()
